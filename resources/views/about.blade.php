        ...
        <div class="col-md-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <h6 class="text-secondary">{{$MvpRealtor->name}}</h6>
              <p class="card-text">{{$MvpRealtor->description}}
              </p>
            </div>
          </div>
        </div>
  ...
  <section id="team" class="py-5">
    <div class="container">
      ...
      <div class="row text-center">
        ...
        <div class="col-md-4">
          <img src="{{$realtor->photo ? asset('storage/' . $realtor->photo) : asset('/images/kyle.jpg')}}" alt="" class="rounded-circle mb-3">
          <h4>{{$realtor->name}}</h4>
